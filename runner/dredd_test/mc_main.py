from runner.dredd_test.mc_worker import MutationTestingWorker
...
def main():
    ...
    for file in sqlite_c_src_c_files:
        ...
        with open(args.test_files_path) as test_files:
            ...
            MutationTestingWorker(mutant_info_script, file, coverage_bin, mutation_bin, mutation_info, args.output_directory).async_slice_runner(tests)
