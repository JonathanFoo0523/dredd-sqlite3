...
from runner.generate_test.main import main
...
#             assert(os.path.isdir(args.dredd_src_path))
#             assert(os.path.isdir(os.path.join(args.dredd_src_path, 'scripts')))
#             print(os.listdir(os.path.join(args.dredd_src_path, 'scripts')))
#             assert(os.path.isfile(os.path.join(args.dredd_src_path, 'scripts', 'query_mutant_info.py')))
#             mutant_info_script = os.path.join(args.dredd_src_path, 'scripts', 'query_mutant_info.py')
#             assert(os.path.isfile(coverage_bin))
#             assert(os.path.isfile(coverage_bin))
